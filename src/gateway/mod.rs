...
<div class="consent"><div class="panel">
  ...
  <div class="warning">This controller will be able to run shell commands, apply structured file patches, capture graphical desktop screenshots, and control the mouse and keyboard on all current and future connected clients until access is revoked.</div>
  <div class="scope"><span>Discover clients</span><strong>Allowed</strong></div>
  <div class="scope"><span>Run commands, apply patches, capture screenshots, and control desktop input</span><strong>Allowed</strong></div>{}
